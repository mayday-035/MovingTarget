...
import com.demo.movingtarget.databinding.FragmentM4Binding


class M4Fragment : Fragment(),View.OnClickListener {

    lateinit var binding: FragmentM4Binding
    ...
    override fun onCreateView(
        ...
        if (currentView == null) {
            currentView = inflater.inflate(R.layout.fragment_m4, container, false)
            binding = FragmentM4Binding.bind(currentView!!)
            init()
            setOnClickListener()
        }
        return currentView!!
    ...
    companion object {
        fun clearEditTextField(binding: FragmentM4Binding) {
            binding.playerTable.p1Time.text = null
            binding.playerTable.p1Name.text = null
            binding.playerTable.p2Time.text = null
            binding.playerTable.p2Name.text = null
            binding.playerTable.p3Time.text = null
            binding.playerTable.p3Name.text = null
            binding.playerTable.p4Time.text = null
            binding.playerTable.p4Name.text = null
            binding.playerTable.p5Time.text = null
            binding.playerTable.p5Name.text = null
            binding.playerTable.p6Time.text = null
            binding.playerTable.p6Name.text = null
        }
    }
    ...
    private fun setOnClickListener() {
        with(binding.playerTable) {
            p1RadioBtn.setOnClickListener(this@M4Fragment)
            p2RadioBtn.setOnClickListener(this@M4Fragment)
            p3RadioBtn.setOnClickListener(this@M4Fragment)
            p4RadioBtn.setOnClickListener(this@M4Fragment)
            p5RadioBtn.setOnClickListener(this@M4Fragment)
            p6RadioBtn.setOnClickListener(this@M4Fragment)
