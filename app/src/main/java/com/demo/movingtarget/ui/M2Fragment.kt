...
import com.demo.movingtarget.databinding.FragmentM2Binding


class M2Fragment : Fragment(), View.OnClickListener{

    lateinit var binding: FragmentM2Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentM2Binding.inflate(inflater, container, false)
        return binding.root
    }/*
        if (currentView == null) {
            currentView = inflater.inflate(R.layout.fragment_m2, container, false)
            binding = FragmentM2Binding.bind(currentView!!)
            init()
            setOnClickListener()
        }
        return currentView!!
    ...
    private fun setOnClickListener() {
        with(binding.playerTable) {
            p1RadioBtn.setOnClickListener(this@M2Fragment)
            p2RadioBtn.setOnClickListener(this@M2Fragment)
            p3RadioBtn.setOnClickListener(this@M2Fragment)
            p4RadioBtn.setOnClickListener(this@M2Fragment)
            p5RadioBtn.setOnClickListener(this@M2Fragment)
            p6RadioBtn.setOnClickListener(this@M2Fragment)
